...
public class SendSMS {
  public static void main(String[] args) {
    ...
    String number1 = "01066251025";
    String number2 = "01075085354";
    ...
    values.put("type", "SMS");
    values.put("text", "Test Message"+"fdsafdsaggg");
    values.put("app_version", "JAVA SDK v1.2");


//    HashMap<String, String> params = new HashMap<>();
//    params.put("to", number1); // 수신번호
//    params.put("from", "01066251025"); // 발신번호
//    params.put("type", "SMS"); // Message type ( SMS, LMS, MMS, ATA )
//    params.put("text", "Test Message"+number1+" gasfgfasd"); // 문자내용
